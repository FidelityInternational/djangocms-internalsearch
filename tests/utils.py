...
class BaseTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        # create page Internalsearch requests and actions
        cls.Internalsearch_request1 = PageInternalsearchRequest.objects.create(
            page=cls.pg1, language='en', workflow=cls.wf1, is_active=True,)
        cls.Internalsearch_request1.actions.create(by_user=cls.user, action=constants.ACTION_STARTED,)

        PageInternalsearchRequest.objects.create(
            page=cls.pg1, language='en', workflow=cls.wf1, is_active=False,)
        PageInternalsearchRequest.objects.create(
            page=cls.pg2, language='en', workflow=cls.wf2, is_active=False,)

        cls.Internalsearch_request2 = PageInternalsearchRequest.objects.create(
            page=cls.pg3, language='en', workflow=cls.wf2, is_active=True,)
        cls.Internalsearch_request2.actions.create(
        ...
        cls.Internalsearch_request3 = PageInternalsearchRequest.objects.create(
            page=cls.pg4, language='en', workflow=cls.wf3, is_active=True,)
        cls.Internalsearch_request3.actions.create(by_user=cls.user, action=constants.ACTION_STARTED,)
        cls.Internalsearch_request3.actions.create(
            by_user=cls.user,
            to_user=cls.user2,
